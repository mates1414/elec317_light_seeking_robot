...
RESET:
	...
	; initialize threshold for sensor comparison
...
one_one:
    ...
    ;com temp
;right_bigger:
    ;cpi temp, compare_threshold
    ;brlo equal
    ; Right sensor significantly bigger - turn RIGHT
    ;rcall set_turn_right
    ;rjmp one_one_end
;left_bigger:
    ;cpi temp, compare_threshold
    ;brlo equal
...
right_1:
	...
	brlo one_zero
one_one:
	mov motor_right, temp2
	subi temp, - B_controller
	mov motor_left, temp ; + 16 for PORT A and B controller difference
	ret
right_0:
	cp sensor_left, threshold
	brlo zero_zero
...
set_motors_forward:
    ...
    mov motor_right, sensor_left
	mov motor_left, sensor_right 
    ret

;-------------------------------------------------------------------------
; SUBROUTINE: SET_TURN_LEFT
...
set_turn_left:
    ...
    mov motor_right, sensor_left
	mov motor_left, sensor_left 
    ret

;-------------------------------------------------------------------------
; SUBROUTINE: SET_TURN_RIGHT
